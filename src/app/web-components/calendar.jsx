...
export default function Calendar({onChange,minDate,maxDate}) {
  ...
  return (
    <>
      <calendar-range min={minDate} max={maxDate} value={value}  onchange={(event) => handleDateChange(event.target.value)} class="cally bg-base-200 border border-base-300 rounded-box">
