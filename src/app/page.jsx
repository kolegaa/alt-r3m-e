    ...
    <main>
      ...
      <div className="flex flex-row m-4 sticky top-2 z-10 w-9">
        ...
        <label className="input rounded-field bg-base-200 border border-base-300 grow w-56">
          ...
          <input type="search" className="grow w-48" placeholder="Search" />
        </label>
        <div className="join rounded-field flex-none ml-4">
          <button className="btn join-item btn-secondary">Apply</button>
          <button className="btn join-item btn-primary">Reset</button>
        </div>
      </div>
